...
if(!empty($_GET['message']) && $_GET['message'] == 'error_inscription') {
	$msgError = '<div class="alert alert-danger">Erreur lors de l\'inscription veuillez reesayer</div>';
}

if(!empty($_GET['message']) && $_GET['message'] == 'error') {
  $msgError = '<div class="alert alert-danger">Erreur dans les identifiants</div>';
}
    ...
    <div class="col-md-6 col-md-offset-3">
      <div class="panel panel-login">
        ...
        <div class="panel-body">
          <div class="row">
            <div class="col-lg-12">
              <form id="login-form" action="traitement-connexion.php" method="post" role="form" style="display: block;">
                <div class="form-group">
                  <input type="text" name="email" id="email" tabindex="1" class="form-control" placeholder="Prenom" value="">
                </div>
                <div class="form-group">
              ...
              <form id="register-form" action="traitement-inscription.php" method="post" role="form" style="display: none;">
                <div class="form-group">
